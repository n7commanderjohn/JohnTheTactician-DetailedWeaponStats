...
const MYMOD_LOG = "JohnTheTactician-DetailedWeaponStats" # full ID of your mod (AuthorName-ModName)
...
func _init(_modLoader = ModLoaderMod):
	...
	# modLoader.install_script_extension(ext_dir + "weapons/weapon_stats/weapon_stats.gd")
	...
	# ! needed to chain install the actual mod above
	ModLoaderMod.install_script_extension("res://mods-unpacked/JohnTheTactician-DetailedWeaponStats/extensions/singletons/menu_data.gd")
