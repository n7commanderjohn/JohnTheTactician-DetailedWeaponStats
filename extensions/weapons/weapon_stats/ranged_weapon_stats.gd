...
const MYMOD_LOG_RANGED = "JohnTheTactician-DetailedWeaponStats-ranged" # ! Change `MODNAME` to your actual mod's name


# Called when the node enters the scene tree for the first time.
func _ready():
	ModLoaderLog.info("Ready for weapon detail stats", MYMOD_LOG_RANGED)
